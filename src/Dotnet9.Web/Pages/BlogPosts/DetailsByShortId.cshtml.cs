...
public class DetailsByShortIdModel : PageModel
{
    ...
    public DetailsByShortIdModel(IBlogPostService service, Dotnet9DbContext dbContext, IEventBus eventBus,
    ...
    public async Task OnGet()
    {
        ...
        if (Current != null)
        {
            _eventBus.Publish("Dotnet9.Web.BlogPosts.OnGet", new ReadBlogPostEvent(Current!.Slug));
        }
    }
}