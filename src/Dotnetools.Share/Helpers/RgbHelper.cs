...
internal static class RgbHelper
{
    internal static List<ColorCategory> Colors = new List<ColorCategory>
    {
        new ColorCategory
        {
            ...
            Shades = new List<ColorItem>
            {
                ...
                new ColorItem { Name = "darkslategray", HexCode = "#2f4f4f", RGB = "47, 79, 79", HSL = "180, 25%, 25%" },
        ...
        new ColorCategory
        {
            ...
            Shades = new List<ColorItem>
            {
                ...
                new ColorItem { Name = "lightsalmon", HexCode = "#ffa07a", RGB = "255, 160, 122", HSL = "17, 100%, 74%" },
        ...
        new ColorCategory
        {
            ...
            Shades = new List<ColorItem>
            {
                ...
                new ColorItem { Name = "navajowhite", HexCode = "#ffdead", RGB = "255, 222, 173", HSL = "36, 100%, 84%" },
                ...
                new ColorItem { Name = "darkgoldenrod", HexCode = "#b8860b", RGB = "184, 134, 11", HSL = "43, 89%, 38%" },
        ...
        new ColorCategory
        {
            ...
            Shades = new List<ColorItem>
            {
                ...
                new ColorItem { Name = "lightcyan", HexCode = "#e0ffff", RGB = "224, 255, 255", HSL = "180, 100%, 94%" },
                new ColorItem { Name = "paleturquoise", HexCode = "#afeeee", RGB = "175, 238, 238", HSL = "180, 65%, 81%" },
                new ColorItem { Name = "aquamarine", HexCode = "#7fffd4", RGB = "127, 255, 212", HSL = "160, 100%, 75%" },
                ...
                new ColorItem { Name = "darkturquoise", HexCode = "#00ced1", RGB = "0, 206, 209", HSL = "181, 100%, 41%" },
                ...
                new ColorItem { Name = "powderblue", HexCode = "#b0e0e6", RGB = "176, 224, 230", HSL = "187, 52%, 80%" },
                ...
                new ColorItem { Name = "lightskyblue", HexCode = "#87cefa", RGB = "135, 206, 250", HSL = "203, 92%, 75%" },
                new ColorItem { Name = "deepskyblue", HexCode = "#00bfff", RGB = "0, 191, 255", HSL = "195, 100%, 50%" },
                new ColorItem { Name = "dodgerblue", HexCode = "#1e90ff", RGB = "30, 144, 255", HSL = "210, 100%, 56%" },
                new ColorItem
                {
        ...
        new ColorCategory
        {
            ...
            Shades = new List<ColorItem>
            {
                new ColorItem { Name = "greenyellow", HexCode = "#adff2f", RGB = "173, 255, 47", HSL = "84, 100%, 59%" },
                ...
                new ColorItem { Name = "lightgreen", HexCode = "#90ee90", RGB = "144, 238, 144", HSL = "120, 73%, 75%" },
                new ColorItem
                {
                    Name = "mediumspringgreen", HexCode = "#00fa9a", RGB = "0, 250, 154", HSL = "157, 100%, 49%"
                },
                new ColorItem { Name = "springgreen", HexCode = "#00ff7f", RGB = "0, 255, 127", HSL = "150, 100%, 50%" },
                new ColorItem { Name = "mediumseagreen", HexCode = "#3cb371", RGB = "60, 179, 113", HSL = "147, 50%, 47%" },
                ...
                new ColorItem { Name = "darkolivegreen", HexCode = "#556b2f", RGB = "85, 107, 47", HSL = "82, 39%, 30%" },
                new ColorItem
                {
                    Name = "mediumaquamarine", HexCode = "#66cdaa", RGB = "102, 205, 170", HSL = "160, 51%, 60%"
                },
                new ColorItem { Name = "darkseagreen", HexCode = "#8fbc8b", RGB = "143, 188, 139", HSL = "115, 27%, 64%" },
                new ColorItem { Name = "lightseagreen", HexCode = "#20b2aa", RGB = "32, 178, 170", HSL = "177, 70%, 41%" },
        ...
        new ColorCategory
        {
            ...
            Shades = new List<ColorItem>
            {
                ...
                new ColorItem { Name = "lightpink", HexCode = "#ffb6c1", RGB = "255, 182, 193", HSL = "351, 100%, 86%" },
                ...
                new ColorItem { Name = "palevioletred", HexCode = "#db7093", RGB = "219, 112, 147", HSL = "340, 60%, 65%" }
            }
        },
        new ColorCategory
        {
            ...
            Shades = new List<ColorItem>
            {
                ...
                new ColorItem { Name = "mediumorchid", HexCode = "#ba55d3", RGB = "186, 85, 211", HSL = "288, 59%, 58%" },
                new ColorItem { Name = "mediumpurple", HexCode = "#9370db", RGB = "147, 112, 219", HSL = "260, 60%, 65%" },
                new ColorItem { Name = "rebeccapurple", HexCode = "#663399", RGB = "102, 51, 153", HSL = "270, 50%, 40%" },
                ...
                new ColorItem { Name = "darkmagenta", HexCode = "#8b008b", RGB = "139, 0, 139", HSL = "300, 100%, 27%" },
                ...
                new ColorItem { Name = "darkslateblue", HexCode = "#483d8b", RGB = "72, 61, 139", HSL = "248, 39%, 39%" },
                new ColorItem
                {
                    Name = "mediumslateblue", HexCode = "#7b68ee", RGB = "123, 104, 238", HSL = "249, 80%, 67%"
                }
        ...
        new ColorCategory
        {
            ...
            Shades = new List<ColorItem>
            {
                ...
                new ColorItem { Name = "mintcream", HexCode = "#f5fffa", RGB = "245, 255, 250", HSL = "150, 100%, 98%" },
                new ColorItem { Name = "azure", HexCode = "#f0ffff", RGB = "240, 255, 255", HSL = "180, 100%, 97%" },
                new ColorItem { Name = "aliceblue", HexCode = "#f0f8ff", RGB = "240, 248, 255", HSL = "208, 100%, 97%" },
                new ColorItem { Name = "ghostwhite", HexCode = "#f8f8ff", RGB = "248, 248, 255", HSL = "240, 100%, 99%" },
                ...
                new ColorItem { Name = "floralwhite", HexCode = "#fffaf0", RGB = "255, 250, 240", HSL = "40, 100%, 97%" },
                new ColorItem { Name = "ivory", HexCode = "#fffff0", RGB = "255, 255, 240", HSL = "60, 100%, 97%" },
                new ColorItem { Name = "antiquewhite", HexCode = "#faebd7", RGB = "250, 235, 215", HSL = "34, 78%, 91%" },
        ...
        new ColorCategory
        {
            ...
            Shades = new List<ColorItem>
            {
                ...
                new ColorItem { Name = "lightyellow", HexCode = "#ffffe0", RGB = "255, 255, 224", HSL = "60, 100%, 94%" },
                new ColorItem { Name = "lemonchiffon", HexCode = "#fffacd", RGB = "255, 250, 205", HSL = "54, 100%, 90%" },
                new ColorItem
                {
                    Name = "lightgoldenrodyellow", HexCode = "#fafad2", RGB = "250, 250, 210", HSL = "60, 80%, 90%"
                },
                new ColorItem { Name = "papayawhip", HexCode = "#ffefd5", RGB = "255, 239, 213", HSL = "37, 100%, 92%" },
                ...
                new ColorItem { Name = "palegoldenrod", HexCode = "#eee8aa", RGB = "238, 232, 170", HSL = "55, 67%, 80%" },
    ...
    public static Color ParseHEX(string val)
    {
        Color color = new Color();
        try
        {
            Regex rgx = new Regex(@"^#?([a-f\\d])([a-f\\d])([a-f\\d])$", RegexOptions.IgnoreCase);
            string hex = rgx.Replace(val,
                m =>
                {
                    return m.Groups[1].Value + m.Groups[1].Value + m.Groups[2].Value + m.Groups[2].Value +
                           m.Groups[3].Value + m.Groups[3].Value;
                });
            Match rgb = Regex.Match(hex, @"^#?([a-f\\d]{2})([a-f\\d]{2})([a-f\\d]{2})$", RegexOptions.IgnoreCase);
            color.r = int.Parse(rgb.Groups[1].Value, NumberStyles.HexNumber);
            color.g = int.Parse(rgb.Groups[2].Value, NumberStyles.HexNumber);
            color.b = int.Parse(rgb.Groups[3].Value, NumberStyles.HexNumber);
        }
        catch (Exception e)
        {
            Console.WriteLine(e);
    ...
    public static Color ParseRGBA(string val)
    {
        Color color = new Color();
        try
        {
            Match rgba = Regex.Match(val, @"^rgba?\\((\\d+),\\s*(\\d+),\\s*(\\d+)(?:,\\s*(\\d+(?:\\.\\d+)?))?\\)$");
            color.r = int.Parse(rgba.Groups[1].Value);
            color.g = int.Parse(rgba.Groups[2].Value);
            color.b = int.Parse(rgba.Groups[3].Value);
            color.a = double.Parse(rgba.Groups[4].Value ?? "1");
        }
        catch (Exception e)
        {
            Console.WriteLine(e);
    ...
    public static Color ParseARGB(string val)
    {
        ...
        try
        {
            ...
            color.r = int.Parse(argb.Groups[2].Value, NumberStyles.HexNumber);
            color.g = int.Parse(argb.Groups[3].Value, NumberStyles.HexNumber);
            color.b = int.Parse(argb.Groups[4].Value, NumberStyles.HexNumber);
            color.a = int.Parse(argb.Groups[1].Value, NumberStyles.HexNumber) / 255.0;
        }
        catch (Exception e)
        {
            Console.WriteLine(e);
    ...
    public static Color ParseHSL(string hslValue)
    {
        ...
        try
        {
            Match hsl = Regex.Match(hslValue, @"hsl\((\\d+),\\s*([\\d.]+)%,\\s*([\\d.]+)%\\)");
            double h = int.Parse(hsl.Groups[1].Value) / 360.0;
            double s = int.Parse(hsl.Groups[2].Value) / 100.0;
            double l = int.Parse(hsl.Groups[3].Value) / 100.0;
            double r, g, b;
            if (s == 0)
            {
                r = g = b = l;
