...
<template>
  <div flex flex-col gap-4>
    <c-input-text v-model:value="plainText" multiline raw-text placeholder="用于计算哈希的纯文本..." rows="3" autosize autofocus label="用于计算哈希的纯文本" />
    ...
    <input-copyable v-model:value="hmac" type="textarea" placeholder="The result of the HMAC..." label="生成的HMAC" />
