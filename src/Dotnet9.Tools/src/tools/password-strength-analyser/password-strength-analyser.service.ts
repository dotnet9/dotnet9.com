...
function getHumanFriendlyDuration({ seconds }: { seconds: number }) {
  ...
  const timeUnits = [
    { unit: 'millenium', secondsInUnit: 31536000000, format: prettifyExponentialNotation, plural: '一千年' },
    { unit: 'century', secondsInUnit: 3153600000, plural: '世纪' },
    ...
    { unit: 'minute', secondsInUnit: 60, plural: '分' },
