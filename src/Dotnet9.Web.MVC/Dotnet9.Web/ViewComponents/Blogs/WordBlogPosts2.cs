...
public class WordBlogPosts2 : ViewComponent
{
    private readonly ICacheService _cacheService;
    private readonly ICategoryAppService _categoryAppService;
    private readonly IMapper _mapper;

    public WordBlogPosts2(ICategoryAppService categoryAppService, ICacheService cacheService, IMapper mapper)
    {
    ...
    {
        const string cacheKey = $"{nameof(WordBlogPosts2)}-{nameof(InvokeAsync)}";
