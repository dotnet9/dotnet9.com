...
1. 后端使用使用`ASP.NET Core 8.0`开发，前端使用Vue 3.2
2. 带博客浏览功能
3. 带工具使用
...
- Dotnetools：[https://dotnetools.com](https://dotnetools.com)
...
![](assets/Dotnet工具箱首页.png)

Dotnet工具箱-别名工具

![](assets/Dotnet工具箱-别名工具.png)
